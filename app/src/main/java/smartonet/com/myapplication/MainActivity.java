    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connection.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mClient = initClient("tcp://localhost:1883", "id（唯一）", mqttCallback, mOptions, new String[]{"HelloWorld"});
                mClient2=initClient("tcp://localhost:1883","id（唯一）",mqttCallback,mOptions,new String[]{"HelloWorld"});
            }
        });
        ...
        mHandler = new MyHandler(MainActivity.this,showtext);
    }
